...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "aiandeh.sazan.run", "aiandeh.sazan.run.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "aiandeh.sazan.run.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
