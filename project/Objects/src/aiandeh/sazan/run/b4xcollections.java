...
public static aiandeh.sazan.run.b4xbitset  _vvv6(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
aiandeh.sazan.run.b4xbitset _s = null;
...
_s = new aiandeh.sazan.run.b4xbitset();
...
public static aiandeh.sazan.run.b4xorderedmap  _vvv7(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static aiandeh.sazan.run.b4xorderedmap  _vvv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
aiandeh.sazan.run.b4xorderedmap _m = null;
int _i = 0;
...
_m = new aiandeh.sazan.run.b4xorderedmap();
...
public static aiandeh.sazan.run.b4xset  _vvvv1(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static aiandeh.sazan.run.b4xset  _vvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
aiandeh.sazan.run.b4xset _s = null;
Object _v = null;
...
_s = new aiandeh.sazan.run.b4xset();
