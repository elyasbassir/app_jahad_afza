...
public class b4xpagesdelegator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "aiandeh.sazan.run.b4xpagesdelegator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", aiandeh.sazan.run.b4xpagesdelegator.class).invoke(this, new Object[] {null});
        else
...
_vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._activity_actionbarhomeclick /*String*/ ();
...
if (true) return _vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._activity_keypress /*boolean*/ (_keycode);
...
_vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._activity_pause /*String*/ ();
...
_vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvvv2 /*String*/ (_vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvv7 /*aiandeh.sazan.run.b4xpagesmanager._b4xpageinfo*/ (),"B4XPage_PermissionResult",new Object[]{(Object)(_permission),(Object)(_result)});
...
_vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._activity_resume /*String*/ ();
...
_vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvv1 /*String*/ (_menu);
...
_vvvvvv2._vv4 /*aiandeh.sazan.run.b4xpagesmanager*/ (getActivityBA())._mainform_resize /*String*/ (_width,_height);
